describe('Prototypes', () => {
	...
	describe('extensions', () => {
		it('can provide additional features', () => {
			/*let e = [];
			function result(e) {
				let max = Math.max.apply(null, e);
				let min = Math.min.apply(null, e);
			}
			return e;*/
			...
			// Array.prototype.min and Array.prototype.max // .apply comment fonctionne prototypes / comment fonctionne méthode pr tab
